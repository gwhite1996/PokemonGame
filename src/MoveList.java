public class MoveList{
	...
	final static Move struggle = new Move(struggleMoveName); // each pokemon uses the same MOVE for and 'none'
	...
	final static MoveName thunderShock = new MoveName("Thunder Shock", Type.ELECTRIC, MoveCategory.SPECIAL, 40, 100,
			30){
