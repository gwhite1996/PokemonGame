...
public class Battle{
	...
	public boolean playerActsFirst(Pokemon enemyPokemon, Action enemyAction){
	...
	public void resetAllStatStages(Party party){ // resets stages to 0 for both parties before and after battle
