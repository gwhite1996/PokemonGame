...
public class TextPanel extends JPanel{
	...
	public TextPanel(int frameWidth){
		...
		panelDimensions = new Dimension(frameWidth, (int)(frameWidth/4.0)); //Makes frame a little bigger than frameWidth to account for the window edges
		...
		message = new JLabel("Wiill be blank", SwingConstants.CENTER);
