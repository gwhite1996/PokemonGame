...
public abstract class TurnablePanel extends AbstractPanel{
	...
	void update(int x, int y, Direction dir) {
		...
		this.dir = dir;
		switch(dir){
		case EAST:img = imgEast;break;
		case NORTH:img = imgNorth;break;
		case SOUTH:img = imgSouth;break;
		case WEST:img = imgWest;break;
		default:System.out.println("Invalid direction within TurnablePanel");break;
		}
	}
}
